...
public interface BasictransitionrulesPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int DELAYED_RULE__GUARD = BASIC_RULE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int DELAYED_RULE__MIN = BASIC_RULE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int DELAYED_RULE__DELAY = BASIC_RULE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int DELAYED_RULE__THEN_RULE = BASIC_RULE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int DELAYED_RULE_FEATURE_COUNT = BASIC_RULE_FEATURE_COUNT + 4;
	 ...
	 * @generated
	 */
	EReference getDelayedRule_Guard();
	 ...
	 * @generated
	 */
	EReference getDelayedRule_Delay();
	 ...
	 * @generated
	 */
	EReference getDelayedRule_ThenRule();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EClass DELAYED_RULE = eINSTANCE.getDelayedRule();
		 ...
		 * @generated
		 */
		EReference DELAYED_RULE__GUARD = eINSTANCE.getDelayedRule_Guard();
		 ...
		 * @generated
		 */
		EReference DELAYED_RULE__MIN = eINSTANCE.getDelayedRule_Min();
		 ...
		 * @generated
		 */
		EReference DELAYED_RULE__DELAY = eINSTANCE.getDelayedRule_Min();
		 ...
		 * @generated
		 */
		EReference DELAYED_RULE__THEN_RULE = eINSTANCE.getDelayedRule_ThenRule();

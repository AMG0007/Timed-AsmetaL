...
public class BasictransitionrulesPackageImpl extends EPackageImpl implements BasictransitionrulesPackage {
	 ...
	 * @generated
	 */
	private EClass delayedRuleEClass = null;
	...
	public static BasictransitionrulesPackage init() {
		...
		BasictransitionrulesPackageImpl theBasictransitionrulesPackage = (BasictransitionrulesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BasictransitionrulesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BasictransitionrulesPackageImpl());
	 ...
	 * @generated
	 */
	public EClass getDelayedRule() {
		return delayedRuleEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getDelayedRule_Guard() {
		return (EReference)delayedRuleEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getDelayedRule_Min() {
		return (EReference)delayedRuleEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getDelayedRule_Delay() {
		return (EReference)delayedRuleEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getDelayedRule_ThenRule() {
		return (EReference)delayedRuleEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		delayedRuleEClass = createEClass(DELAYED_RULE);
		createEReference(delayedRuleEClass, DELAYED_RULE__GUARD);
		createEReference(delayedRuleEClass, DELAYED_RULE__MIN);
		createEReference(delayedRuleEClass, DELAYED_RULE__DELAY);
		createEReference(delayedRuleEClass, DELAYED_RULE__THEN_RULE);
	...
	public void initializePackageContents() {
		...
		delayedRuleEClass.getESuperTypes().add(this.getBasicRule());
		...
		initEClass(delayedRuleEClass, DelayedRule.class, "DelayedRule", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDelayedRule_Guard(), theBasictermsPackage.getTerm(), null, "guard", null, 1, 1, DelayedRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getDelayedRule_Min(), theBasictermsPackage.getTerm(), null, "min", null, 1, 1, DelayedRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getDelayedRule_Delay(), theBasictermsPackage.getTerm(), null, "delay", null, 1, 1, DelayedRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getDelayedRule_ThenRule(), this.getRule(), null, "thenRule", null, 1, 1, DelayedRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

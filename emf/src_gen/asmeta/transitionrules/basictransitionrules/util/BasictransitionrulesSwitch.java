...
public class BasictransitionrulesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BasictransitionrulesPackage.DELAYED_RULE: {
				DelayedRule delayedRule = (DelayedRule)theEObject;
				T result = caseDelayedRule(delayedRule);
				if (result == null) result = caseBasicRule(delayedRule);
				if (result == null) result = caseRule(delayedRule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDelayedRule(DelayedRule object) {
		return null;
	}

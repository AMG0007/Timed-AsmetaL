...
/** questa classe serve solamente perch� EMF non genera
 * le istanze dei package senza classi
 * non servirebeb perch� poi richiama le eInstance corrette
 * nei package contenuti 
 * @author pscandurra
 *
 */

...
public class SequenceValue extends CollectionValue {
	...
	private List<Value> sequence;
	
	/**
	 * Copy constructor.
	 *  
	 */
	public SequenceValue(SequenceValue sv) {
		sequence = new ArrayList<Value>(sv.sequence);
	}
	 ...
	 */
	public SequenceValue(List<Value> sequence) {
	...
	public String toString() {
		...
		Iterator<Value> i = sequence.iterator();
		if (i.hasNext()) {
			s.append(i.next());
			while (i.hasNext()) {
				s.append("," + i.next());
